...
const navigation = [
  { name: 'Discover', href: '#', icon: BuildingStorefrontIcon, current: true },
  { name: 'Search', href: '#', icon: MagnifyingGlassIcon, current: false },
  { name: 'Watching', href: '#', icon: HeartIcon, current: false },
  { name: 'Coupons', href: '#', icon: HandThumbUpIcon, current: false },
      ...
      <div>
        ...
        <div className="flex flex-1 flex-col lg:pl-64">
          <div className="sticky top-0 z-10 bg-gray-100 pl-1 pt-1 sm:pl-3 sm:pt-3 lg:hidden">
            <button
              type="button"
              className="-ml-0.5 -mt-0.5 inline-flex h-12 w-12 items-center justify-center rounded-md text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-dark"
